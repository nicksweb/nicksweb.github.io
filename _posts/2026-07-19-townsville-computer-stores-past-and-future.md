---
title: Townsville computer stores — remembering the past and making the case for what comes next
...
The [history of Townsville computer stores and centres](https://www.tsvcomputerman.com.au/news/townsville-computer-stores-and-centres/) records some of the names that helped build the local computer community.
...
Digital Matrix Computers became one of the most recognisable businesses of the following era. It supplied complete systems, parts and repairs, and developed a loyal local customer base. The [fire near the Warrina Shopping Complex in February 2026](https://www.abc.net.au/news/2026-02-09/police-investigate-string-of-townsville-crime-one-million-strong/106320796), and the later news that Digital Matrix would not reopen, represented a real loss for Townsville.
...
That is why I think retailers such as [Computer Alliance](https://www.computeralliance.com.au/) or [Umart](https://www.umart.com.au/) should seriously investigate a Townsville presence.
