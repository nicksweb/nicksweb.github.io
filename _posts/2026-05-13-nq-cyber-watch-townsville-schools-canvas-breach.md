...
*(Details above are drawn from local reporting by the [Townsville Bulletin](https://www.townsvillebulletin.com.au/news/townsville/townsville-schools-caught-in-global-hack-as-student-data-threatened/news-story/5ff74d2668aca7171c902f9a86e8519d){:target="_blank" rel="noopener noreferrer"}, credited in full — read the original article for the complete account, including comment from Annandale Christian College's principal.)*
...
If your school, business or not-for-profit wants an outside view on vendor and platform risk, [Suburban Secure's managed IT services](https://suburbansecure.au/managed-it-services/){:target="_blank" rel="noopener noreferrer"} include exactly this kind of review, including for organisations around [Townsville](https://suburbansecure.au/locations/townsville-qld/managed-services/){:target="_blank" rel="noopener noreferrer"} and North Queensland.
