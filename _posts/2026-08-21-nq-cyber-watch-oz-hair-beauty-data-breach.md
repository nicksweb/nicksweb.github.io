---
title: "North Queensland Cyber Watch: Oz Hair & Beauty confirms customer data was accessed"
...
Oz Hair & Beauty has published an [official cyber incident statement](https://www.ozhairandbeauty.com/pages/official-statement-regarding-cyber-incident){:target="_blank" rel="noopener noreferrer"} saying it began a forensic investigation and containment work as soon as it became aware of the incident, with technical specialists from its cloud e-commerce platform provider.
...
![Second section of Oz Hair & Beauty's official cyber incident statement listing the customer information accessed and confirming that card details, passwords and invoices were not involved.](/assets/images/OZHairBeauty-Letter-Part2-OnWebsite.png){: width="850" }
_The second section of Oz Hair & Beauty's official statement. Screenshot retained for reporting and commentary._
...
An earlier [Recent Breaches report](https://recentbreaches.com/breach/oz-hair-and-beauty-confirms-cyber-incident-what-it-means-for-customers-2026-08){:target="_blank" rel="noopener noreferrer"} described a published file said to contain about two million email addresses together with names, phone numbers, suburb-level locations and purchase-related information. That is third-party reporting, not a number Oz Hair & Beauty has confirmed in its official statement.
...
This is the same practical lesson that came out of the [Nick Scali incident]({% post_url 2026-08-14-nq-cyber-watch-nick-scali-security-incident %}). Retail records do not need to contain financial credentials to support a convincing impersonation attempt.
...
The [ABC reported in 2024](https://www.abc.net.au/news/2024-03-26/coles-and-woolworths-using-rewards-cards-to-collect-data/103612082){:target="_blank" rel="noopener noreferrer"} on concerns about the consumer data collected through Coles' Flybuys and Woolworths' Everyday Rewards programs. Those schemes can collect what, how, when and where customers buy, then use that information for personalised marketing and insights into customer behaviour.
...
![Oz Hair & Beauty website support message acknowledging a high influx of customer tickets after the data incident and advising that updates may take 48 hours.](/assets/images/OZHairBeauty-Website-HelpTool-Agent.png){: width="403" }
_The customer support message visible on the Oz Hair & Beauty website after the incident._
...
- **Verify uncertain messages directly.** The company lists `privacy@ozhairandbeauty.com` for incident questions.
